...
DESCRIPTOR = _descriptor.FileDescriptor(
    name='insanic/grpc/health/health.proto',
    package='insanic.v1',
    syntax='proto3',
    serialized_pb=_b(
        '\n insanic/grpc/health/health.proto\x12\ninsanic.v1\"%\n\x12HealthCheckRequest\x12\x0f\n\x07service\x18\x01 \x01(\t\"\xa5\x01\n\x13HealthCheckResponse\x12=\n\x06status\x18\x01 \x01(\x0e\x32-.insanic.v1.HealthCheckResponse.ServingStatus\"O\n\rServingStatus\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x0b\n\x07SERVING\x10\x01\x12\x0f\n\x0bNOT_SERVING\x10\x02\x12\x13\n\x0fSERVICE_UNKNOWN\x10\x03\x32\x9e\x01\n\x06Health\x12H\n\x05\x43heck\x12\x1e.insanic.v1.HealthCheckRequest\x1a\x1f.insanic.v1.HealthCheckResponse\x12J\n\x05Watch\x12\x1e.insanic.v1.HealthCheckRequest\x1a\x1f.insanic.v1.HealthCheckResponse0\x01\x42\x61\n\x11io.grpc.health.v1B\x0bHealthProtoP\x01Z,google.golang.org/grpc/health/grpc_health_v1\xaa\x02\x0eGrpc.Health.V1b\x06proto3')
)

_HEALTHCHECKRESPONSE_SERVINGSTATUS = _descriptor.EnumDescriptor(
    name='ServingStatus',
    full_name='insanic.v1.HealthCheckResponse.ServingStatus',
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
    ...
    full_name='insanic.v1.HealthCheckRequest',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='service', full_name='insanic.v1.HealthCheckRequest.service', index=0,
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
    ...
    full_name='insanic.v1.HealthCheckResponse',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='status', full_name='insanic.v1.HealthCheckResponse.status', index=0,
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), dict(
    ...
    __module__='insanic.grpc.health.health_pb2'
    # @@protoc_insertion_point(class_scope:insanic.v1.HealthCheckRequest)
))
...
HealthCheckResponse = _reflection.GeneratedProtocolMessageType('HealthCheckResponse', (_message.Message,), dict(
    ...
    __module__='insanic.grpc.health.health_pb2'
    # @@protoc_insertion_point(class_scope:insanic.v1.HealthCheckResponse)
))
...
_HEALTH = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            name='Check',
            full_name='insanic.v1.Health.Check',
            index=0,
        ...
        _descriptor.MethodDescriptor(
            name='Watch',
            full_name='insanic.v1.Health.Watch',
            index=1,
            containing_service=None,
            input_type=_HEALTHCHECKREQUEST,
            output_type=_HEALTHCHECKRESPONSE,
